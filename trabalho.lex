...
"dentro de"					{ yylval = Atributo( yytext );  return _INTERVALO; }
"=>"						{ yylval = Atributo( yytext );  return _PIPE; }
"somente se"					{ yylval = Atributo( yytext );  return _FILTER; }
"para cada um"					{ yylval = Atributo( yytext );  return _FOREACH; }
"x"							{ yylval = Atributo( yytext ); return _X; }



"primeiros"  						{ yylval = Atributo( yytext ); return _FIRSTN; }
"ultimos" 						{ yylval = Atributo( yytext ); return _LASTN; }
